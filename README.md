...
> **Docs.** The full documentation is at [porcelain.kenroy.dev](https://porcelain.kenroy.dev/): one page per surface, the known limits, the changelog and the roadmap with where 1.0 gets cut.
